        ...
        {step === "intro" && (
          <div className="space-y-8 text-center animate-in fade-in slide-in-from-bottom-4 duration-700 pb-32">
            ...
            <div className="mx-auto max-w-2xl space-y-4 font-inter text-xl text-text-primary/80">
              <p>
                Chronic Over-Giving • Toxic Relationships • Rediscovering Your
                Passion
              </p>
              <p>
                Welcome, Gen X Woman. This gentle quiz is designed to help you
                reflect on chronic over-giving, toxic or draining relationships,
                and reclaiming your passion and identity in midlife.
              </p>
              <p className="font-medium text-text-primary">
                There are no right or wrong answers — only awareness. Midlife is
                not a crisis. It is a return to yourself.
              </p>
            </div>
            <div className="pt-8">
              <button
